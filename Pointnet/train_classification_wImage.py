...
def main(args):
    ...
    data_path = '/braindat/lab/liusl/flywire/block_data/v2/point_cloud/train_fps_2048'

    train_dataset = FlyTracingDataLoader(root=data_path, split='train', process_data=args.process_data, use_image_feature=args.image_feature, npoints=args.num_point)
    test_dataset = FlyTracingDataLoader(root=data_path, split='test', process_data=args.process_data, use_image_feature=args.image_feature, npoints=args.num_point)
